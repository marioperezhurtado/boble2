...
<form class="flex flex-col gap-3 pt-8">
	...
	<div class="flex justify-between items-center text-xs font-medium text-zinc-500">
		<div class="flex gap-1.5 items-center">
			<input type="checkbox" id="remember" name="remember" class="mb-0.5" checked />
	...
	<button
		type="submit"
		class="p-2 w-full text-sm font-bold text-white bg-cyan-700 rounded-md shadow-sm transition hover:brightness-110 focus:outline-cyan-600"
	>
		Login
	</button>
</form>
