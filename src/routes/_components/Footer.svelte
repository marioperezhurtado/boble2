...
<footer
  class="flex justify-between items-center p-8 mx-auto mt-52 max-w-screen-lg"
>
  <div class="flex gap-2 items-center">
    <img src="/boble.svg" alt="BOBLE logo" class="w-8 h-8" />
  ...
  <div class="flex gap-2 items-center">
    <ActionIconLink
      title="Contact"
      href="mailto:marioph10@gmail.com"
