...
>
	...
	<p class={`leading-3 text-right text-[10px] flex min-w-fit gap-0.5 items-end
	...
	{#if isFirst}
		<span class={`absolute top-0 w-0 h-0 border-transparent border-t-[10px]
        ${isOwn ? 'border-t-cyan-700 border-r-[5px] -right-1'
